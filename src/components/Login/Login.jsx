          ...
          <div className="col-md-4 col-12 bg-white  p-4    ">
            <div className='d-flex flex-column  h-100 '>
              ...
              <div className="d-flex align-items-center mb-4  justify-content-center gap-2  w-100" >
                ...
                <span className=" fw-bold flex-1 fs-5 fs-md-4" style={{color:'var(--mainColor)'}}>Dashboard</span>
              </div>

              <form onSubmit={formik.handleSubmit} className='d-flex flex-column gap-4 justify-content-center  h-100'>
                <div className="mb-2">
                  <input
                    name="username"
                  ...
                  {formik.touched.username && formik.errors.username && (
                    <p className="text-danger small mt-2">{formik.errors.username}</p>
                  )}
                </div>
                ...
                <div className="mb-3">
                  ...
                  {formik.touched.password && formik.errors.password && (
                    <p className="text-danger small mt-2">{formik.errors.password}</p>
                  )}
                </div>

                <button type="submit" className="btn btn-primary w-100 mt-5" style={{ backgroundColor: 'var(--mainColor)',}}>
                  {isLoading ? (
